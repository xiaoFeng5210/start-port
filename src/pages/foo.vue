...
<template>
  <div>Foo</div>
  <div>
    <router-link class="m-3 text-sm btn" to="/">Back</router-link>
  ...
  <div m20>
    ...
    <TheImageProxy :style="{ width: size + 'px', height: size + 'px' }" w-50 h-100 rounded="1/4" />
  </div>
  <!-- <TheImage w-50 h-100 rounded-xl m10 /> -->
</template>
